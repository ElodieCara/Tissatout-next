...
export const sections: Section[] = [
    { title: "Tout-petits", color: "#ECAC3E", buttonImage: Btntp, imageCard: Tp },
    { title: "Dès 3 ans", color: "rgb(2 141 2)", buttonImage: BtnD3, imageCard: D3 },
    { title: "Dès 6 ans", color: "#CF000F", buttonImage: BtnD6, imageCard: D6 },
    { title: "Dès 10 ans", color: "#0066D5", buttonImage: BtnD8, imageCard: D8 },
];
